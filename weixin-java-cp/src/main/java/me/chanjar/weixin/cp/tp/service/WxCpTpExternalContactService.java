...
public interface WxCpTpExternalContactService {
	/**
	   ...
	   */
	WxCpListContactWayResult listContactWay(String corpId, WxCpContactWayListRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpContactWayResult addContactWay(String corpId, WxCpContactWayInfo info) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpContactWayInfo getContactWay(String corpId, String configId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp updateContactWay(String corpId, WxCpContactWayInfo info) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp deleteContactWay(String corpId, String configId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp closeTempChat(String corpId, String userId, String externalUserId) throws WxErrorException;
   ...
   */
  WxCpExternalContactInfo getContactDetail(String corpId, String userId, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException .
   */
  String unionidToExternalUserid(String corpId, String unionid, String openid) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupJoinWayResult addJoinWay(String corpId, WxCpGroupJoinWayInfo wxCpGroupJoinWayInfo) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp updateJoinWay(String corpId, WxCpGroupJoinWayInfo wxCpGroupJoinWayInfo) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupJoinWayInfo getJoinWay(String corpId, String configId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp delJoinWay(String corpId, String configId) throws WxErrorException;
   ...
   * @throws WxErrorException .
   */
  String toServiceExternalUserid(String corpId, String externalUserid) throws WxErrorException;
   ...
   * @throws WxErrorException
   */
  String fromServiceExternalUserid(String corpId, String externalUserid, String sourceAgentId) throws WxErrorException;
   ...
   * @throws WxErrorException .
   */
  WxCpExternalUserIdList unionidToExternalUserid3rd(String corpId, String unionid, String openid, String corpid) throws WxErrorException;
   ...
   * @throws WxErrorException .
   */
  WxCpNewExternalUserIdList getNewExternalUserId(String corpId, String[] externalUserIdList) throws WxErrorException;
   ...
   * @throws WxErrorException .
   */
  String opengidToChatid(String corpId, String opengid) throws WxErrorException;
   ...
   * @throws WxErrorException .
   */
  WxCpExternalContactBatchInfo getContactDetailBatch(String corpId, String[] userIdList, String cursor,
                                                     Integer limit)
    throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpUserExternalUnassignList listUnassignedList(String corpId, Integer pageId, String cursor, Integer pageSize) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpUserTransferResultResp transferResult(String corpId, String handOverUserid, String takeOverUserid,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpUserTransferResultResp resignedTransferResult(String corpId, String handOverUserid, String takeOverUserid,
                                                    String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   * @deprecated 请使用 {@link WxCpTpExternalContactService#listGroupChat(Integer, String, int, String[])}
   */
  @Deprecated
  WxCpUserExternalGroupChatList listGroupChat(String corpId, Integer pageIndex, Integer pageSize, int status, String[] userIds,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpUserExternalGroupChatTransferResp onjobTransferGroupChat(String corpId, String[] chatIds, String newOwner) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpUserExternalUserBehaviorStatistic getUserBehaviorStatistic(String corpId, Date startTime, Date endTime, String[] userIds,
                                                                 String[] partyIds) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpUserExternalGroupChatStatistic getGroupChatStatistic(String corpId, Date startTime, Integer orderBy, Integer orderAsc,
   ...
   * @return the wx cp msg template add result
   */
  WxCpBaseResp remindGroupMsgSend(String corpId, String msgId) throws WxErrorException;
   ...
   * @return the wx cp msg template add result
   */
  WxCpBaseResp cancelGroupMsgSend(String corpId, String msgId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpAddMomentResult addMomentTask(String corpId, WxCpAddMomentTask task) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGetMomentTaskResult getMomentTaskResult(String corpId, String jobId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGetMomentList getMomentList(String corpId, Long startTime, Long endTime, String creator, Integer filterType,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGetMomentTask getMomentTask(String corpId, String momentId, String cursor, Integer limit)
    throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGetMomentCustomerList getMomentCustomerList(String corpId, String momentId, String userId,
                                                  String cursor, Integer limit) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGetMomentSendResult getMomentSendResult(String corpId, String momentId, String userId,
                                              String cursor, Integer limit) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGetMomentComments getMomentComments(String corpId, String momentId, String userId)
    throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupMsgListResult getGroupMsgListV2(String corpId, String chatType, Date startTime, Date endTime,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupMsgSendResult getGroupMsgSendResult(String corpId, String msgid, String userid, Integer limit, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupMsgResult getGroupMsgResult(String corpId, String msgid, Integer limit, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupMsgTaskResult getGroupMsgTask(String corpId, String msgid, Integer limit, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  String addGroupWelcomeTemplate(String corpId, WxCpGroupWelcomeTemplateResult template) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp editGroupWelcomeTemplate(String corpId, WxCpGroupWelcomeTemplateResult template) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpGroupWelcomeTemplateResult getGroupWelcomeTemplate(String corpId, String templateId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp delGroupWelcomeTemplate(String corpId, String templateId, String agentId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpProductAlbumListResult getProductAlbumList(String corpId, Integer limit, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpProductAlbumResult getProductAlbum(String corpId, String productId) throws WxErrorException;
   ...
   */
  WxMediaUploadResult uploadAttachment(String corpId, String mediaType, String fileType, Integer attachmentType,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxMediaUploadResult uploadAttachment(String corpId, String mediaType, Integer attachmentType, File file)
    throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  String addInterceptRule(String corpId, WxCpInterceptRuleAddRequest ruleAddRequest) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  void updateInterceptRule(String corpId, WxCpInterceptRule interceptRule) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  void delInterceptRule(String corpId, String ruleId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  String addProductAlbum(String corpId, WxCpProductAlbumInfo wxCpProductAlbumInfo) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  void updateProductAlbum(String corpId, WxCpProductAlbumInfo wxCpProductAlbumInfo) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  void deleteProductAlbum(String corpId, String productId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpCustomerAcquisitionList customerAcquisitionLinkList(String corpId, Integer limit, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpCustomerAcquisitionInfo customerAcquisitionLinkGet(String corpId, String linkId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpCustomerAcquisitionCreateResult customerAcquisitionLinkCreate(String corpId, WxCpCustomerAcquisitionRequest wxCpCustomerAcquisitionRequest) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp customerAcquisitionUpdate(String corpId, WxCpCustomerAcquisitionRequest wxCpCustomerAcquisitionRequest) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp customerAcquisitionLinkDelete(String corpId, String linkId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpCustomerAcquisitionCustomerList customerAcquisitionCustomer(String corpId, String linkId, Integer limit, String cursor) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpCustomerAcquisitionQuota customerAcquisitionQuota(String corpId) throws WxErrorException;
}
