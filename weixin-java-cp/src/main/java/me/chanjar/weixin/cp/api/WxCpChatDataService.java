 ...
 * @author Hugo
 */
public interface WxCpChatDataService {
   ...
   */
  WxCpChatDataAuthUserList authUserList(@NonNull WxCpChatDataAuthUserRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp setPublicKey(@NonNull WxCpChatDataSetPublicKey request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpChatDataMsgList syncMsg(@NonNull WxCpChatDataSyncMsg request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpChatDataGroupChatInfo groupChatInfo(@NonNull WxCpChatDataGroupChatRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpChatDataAgreeInfo agreeStatus(@NonNull WxCpChatDataAgreeRequest request) throws WxErrorException;
