 ...
 */
public interface WxCpTpOaWeDriveService {
   ...
   */
  WxCpSpaceCreateData spaceCreate(@NonNull WxCpSpaceCreateRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp spaceRename(@NonNull WxCpSpaceRenameRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp spaceDismiss(@NonNull String userId, @NonNull String spaceId, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpSpaceInfo spaceInfo(@NonNull String userId, @NonNull String spaceId, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp spaceAclAdd(@NonNull WxCpSpaceAclAddRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp spaceAclDel(@NonNull WxCpSpaceAclDelRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp spaceSetting(@NonNull WxCpSpaceSettingRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpSpaceShare spaceShare(@NonNull String userId, @NonNull String spaceId, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpFileList fileList(@NonNull WxCpFileListRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpFileUpload fileUpload(@NonNull WxCpFileUploadRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpFileRename fileRename(@NonNull String userId, @NonNull String fileId, @NonNull String newName, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpFileMove fileMove(@NonNull WxCpFileMoveRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp fileDelete(@NonNull String userId, @NonNull List<String> fileId, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp fileAclAdd(@NonNull WxCpFileAclAddRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp fileAclDel(@NonNull WxCpFileAclDelRequest request, String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp fileSetting(@NonNull String userId, @NonNull String fileId, @NonNull Integer authScope, Integer auth,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpFileInfo fileInfo(@NonNull String userId, @NonNull String fileId, String corpId) throws WxErrorException;
