...
public interface WxCpTpMessageService {
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpSchoolContactMessageSendResult sendSchoolContactMessage(String corpId, WxCpSchoolContactMessage message) throws WxErrorException;
   ...
   */
  void recall(String corpId, String msgId) throws WxErrorException;
