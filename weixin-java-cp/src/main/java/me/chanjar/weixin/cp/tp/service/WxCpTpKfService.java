 ...
 */
public interface WxCpTpKfService {
   ...
   */
  WxCpKfAccountAddResp addAccount(String corpId, WxCpKfAccountAdd add) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpBaseResp updAccount(String corpId, WxCpKfAccountUpd upd) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpBaseResp delAccount(String corpId, WxCpKfAccountDel del) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpKfAccountListResp listAccount(String corpId, Integer offset, Integer limit) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpKfAccountLinkResp getAccountLink(String corpId, WxCpKfAccountLink link) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpKfServicerOpResp addServicer(String corpId, String openKfid, List<String> userIdList) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpKfServicerOpResp delServicer(String corpId, String openKfid, List<String> userIdList) throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpKfServicerListResp listServicer(String corpId, String openKfid) throws WxErrorException;
   ...
   */
  WxCpKfServiceStateResp getServiceState(String corpId, String openKfid, String externalUserId)
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpKfServiceStateTransResp transServiceState(String corpId, String openKfid, String externalUserId,
   ...
   */
  @Deprecated
  WxCpKfMsgListResp syncMsg(String corpId, String cursor, String token, Integer limit, Integer voiceFormat)
    throws WxErrorException;

  WxCpKfMsgListResp syncMsg(String corpId, String cursor, String token, Integer limit, Integer voiceFormat,String open_kfid)
    throws WxErrorException;
   ...
   * @throws WxErrorException 异常
   */
  WxCpKfMsgSendResp sendMsg(String corpId, WxCpKfMsgSendRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpKfMsgSendResp sendMsgOnEvent(String corpId, WxCpKfMsgSendRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpKfCustomerBatchGetResp customerBatchGet(String corpId, List<String> externalUserIdList)
    throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpKfGetCorpStatisticResp getCorpStatistic(String corpId, WxCpKfGetCorpStatisticRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpKfGetServicerStatisticResp getServicerStatistic(String corpId, WxCpKfGetServicerStatisticRequest request) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpKfServiceUpgradeConfigResp getUpgradeServiceConfig(String corpId) throws WxErrorException;
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp upgradeMemberService(String corpId, String openKfid, String externalUserId,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp upgradeGroupchatService(String corpId, String openKfid, String externalUserId,
   ...
   * @throws WxErrorException the wx error exception
   */
  WxCpBaseResp cancelUpgradeService(String corpId, String openKfid, String externalUserId)
    throws WxErrorException;
}
